    ...
    public partial class HızlıEkleme : Form
    {
        ...
        private void btnListele_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BindingList<Product> allProducts = GlobalData.productTable.GetAllProducts();
        ...
        {
            GlobalData.productTable.UndoDelete();

            var products = GlobalData.productTable.GetAllProducts();
